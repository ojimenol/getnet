package com.santander.getnet.external.client.model;
...
import com.santander.getnet.external.client.model.auth.Authentication;
import com.santander.getnet.external.client.model.auth.HttpBasicAuth;
import com.santander.getnet.external.client.model.auth.HttpBearerAuth;
import com.santander.getnet.external.client.model.auth.ApiKeyAuth;
import com.santander.getnet.external.client.model.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter implements ExternalClientApi {
    ...
    private String basePath = "https://core.onetrade.dub.dev.api.pagonxt.corp/accounts_validation";
    ...
    protected void init() {
        ...
        authentications.put("JWTProfile", new OAuth());
        authentications.put("bearerJWTAuth", new HttpBearerAuth("bearer"));
